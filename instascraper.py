...
import shutil
class App:
    def __init__(self, username='USERNAME', password='PASSWORD', target_username='TARGET_USERNAME',path='PATH'): 
        #Change this to your Instagram details and desired images path
        self.username = username
        self.password = password
        self.target_username = target_username
        self.path = path
        self.driver = webdriver.Chrome('PATH') #Change this to your ChromeDriver path.
        self.error = False
